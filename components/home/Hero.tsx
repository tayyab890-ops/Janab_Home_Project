...
export default function Hero() {
    ...
    return (
        <section ref={containerRef} className="relative min-h-[90vh] flex items-center overflow-hidden pt-20">
            {/* Background Shapes */}
            <div className="absolute top-0 right-0 -z-10 w-1/2 h-full bg-gradient-to-l from-primary/5 to-transparent rounded-l-full" />
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-12 items-center">
                ...
                <div className="relative h-[400px] flex items-center justify-center">
                    <motion.div
                        style={{ y: riderY, opacity: riderOpacity }}
                        animate={{ x: [0, 20, 0] }}
                        transition={{
                    ...
                    >
                        <div className="relative">
                            {/* Rider Shape */}
                            <div className="w-64 h-64 bg-primary/10 rounded-3xl flex items-center justify-center glass shadow-2xl overflow-hidden group">
                                <Bike className="w-32 h-32 text-primary group-hover:scale-110 transition-transform duration-500" />
                                <div className="absolute -bottom-4 right-4 bg-secondary p-4 rounded-2xl shadow-lg">
